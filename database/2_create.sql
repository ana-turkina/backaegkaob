...
ALTER TABLE audio ADD CONSTRAINT audio_users
...
ALTER TABLE bucketlist ADD CONSTRAINT bucketlist_user
    FOREIGN KEY (user_id)
        REFERENCES "user" (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE funeral_wish ADD CONSTRAINT funeral_wish_funeral
...
ALTER TABLE funeral_wish ADD CONSTRAINT funeral_wish_wish
    FOREIGN KEY (wish_id)
        REFERENCES wish (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE funeral ADD CONSTRAINT funeral_user
    FOREIGN KEY (user_id)
        REFERENCES "user" (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE image ADD CONSTRAINT photo_user
    FOREIGN KEY (user_id)
        REFERENCES "user" (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE relationship ADD CONSTRAINT relationship_friend
...
ALTER TABLE relationship ADD CONSTRAINT relationship_user
    FOREIGN KEY (user_id)
        REFERENCES "user" (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE memory ADD CONSTRAINT text_users
    FOREIGN KEY (users_id)
        REFERENCES "user" (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE "user" ADD CONSTRAINT users_role
    FOREIGN KEY (role_id)
        REFERENCES role (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE video ADD CONSTRAINT video_users
    FOREIGN KEY (users_id)
        REFERENCES "user" (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
